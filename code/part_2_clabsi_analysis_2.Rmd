...
bsi = read.csv('clabsi.csv', header=T)
...
# png("clabsi_time_series_jan06_dec15.png", width=10, height=7.5, res=300, units="in")
 
# clabsi ggplot code goes here
